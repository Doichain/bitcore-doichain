 ...
 * @returns {Promise<*>}
 */
export const getUTXOs4DoiRequest = async (ourAddress,offChainUTXOSs) => {
    ...
    const utxosFromNode = await bitcore.getUTXOAndBalance(ourAddress, amountComplete)
 ...
 * @returns {Promise<*>}
 */
export const getUTXOs4EmailVerificationRequest = async (ourAddress,offChainUTXOSs) => {
